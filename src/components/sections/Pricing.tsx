  ...
  return (
    <section id="pricing" className="px-4 py-20">
      <div className="mx-auto max-w-6xl">
        ...
        <h2 className="mt-3 text-3xl font-medium text-ink-primary">Two ways to use SafeTrace</h2>
        ...
        <div className="mx-auto mt-10 grid max-w-3xl grid-cols-1 gap-6 md:grid-cols-2">
          ...
          <div className="rounded-2xl border-2 border-teal-400 bg-surface-primary p-6">
            ...
            <p className="mt-2 text-sm leading-relaxed text-ink-secondary">
              Integrate SafeTrace into your fleet. Offer premium secure shipping as a paid add-on to customers.
            </p>
            <ul className="mt-5 space-y-2">
