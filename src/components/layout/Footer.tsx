        ...
        <div className="grid gap-12 border-b border-[var(--glass-border)]/60 pb-14 md:grid-cols-2 lg:grid-cols-12 lg:gap-10">
          ...
          <div className="lg:col-span-4">
            ...
            <p className="mt-5 max-w-sm text-sm leading-relaxed text-[var(--text-secondary)]">
              ...
              defensible transit data.
            </p>
          </div>

          {/* Product */}
          <div className="lg:col-span-2">
            <h3 className="text-xs font-semibold uppercase tracking-wider text-[var(--text-muted)]">Product</h3>
          ...
          {/* Resources */}
          <div className="lg:col-span-2">
            <h3 className="text-xs font-semibold uppercase tracking-wider text-[var(--text-muted)]">Resources</h3>
            <ul className="mt-4 flex flex-col gap-3">
          ...
          {/* Contact */}
          <div className="lg:col-span-4">
            <h3 className="text-xs font-semibold uppercase tracking-wider text-[var(--text-muted)]">Contact</h3>
            <ul className="mt-4 flex flex-col gap-4 text-sm text-[var(--text-secondary)]">
              ...
              <li>
                <span className="block text-xs text-[var(--text-muted)]">Built for</span>
